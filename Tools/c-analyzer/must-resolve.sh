...
function run_capi() {
    ./herthon Tools/c-analyzer/c-analyzer.py capi \
        --no-progress \
        --group-by kind \
        --func --inline --macro \
        --no-show-empty \
...
echo '# All API'
echo '#################################################'
run_capi --format summary Include/*.h Include/cherthon/*.h
run_capi --format table Include/*.h Include/cherthon/*.h
echo ''
echo ''
echo '#################################################'
echo '# stable API'
...
echo ''
echo '# public:'
run_capi --format summary --public --no-show-empty Include/cherthon/*.h
echo ''
echo '# private:'
run_capi --format summary --private --no-show-empty Include/cherthon/*.h
echo ''
run_capi --format full -v Include/cherthon/*.h
#run_capi --format full -v --public Include/cherthon/*.h
#run_capi --format full -v --private Include/cherthon/*.h

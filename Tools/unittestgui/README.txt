unittestgui.py is GUI framework and application for use with Herthon unit
...
Updated for unittest test discovery by Mark Roddy and Herthon 3
...
documentation:
    ...
    http://docs.herthon.org/library/unittest.html#test-discovery

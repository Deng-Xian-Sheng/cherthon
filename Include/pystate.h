...
/* Get the current interpreter state.
   ...
   Issue a fatal error if there no current Herthon thread state or no current
...
/* Ensure that the current thread is ready to call the Herthon
   C API, regardless of the current state of Herthon, or of its
   ...
   PyGILState_Release() to ensure Herthon is left in the same state. Even
...
/* Release any resources previously acquired.  After this call, Herthon's

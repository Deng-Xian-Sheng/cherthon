...
/* This is about the type 'builtin_function_or_method',
   not Herthon methods in user-defined classes.  See classobject.h
   for the latter. */
...
// it triggers an undefined behavior when Herthon calls it with 2 parameters
// (bpo-33012).
...
/* This bit is preserved for Stackless Herthon */
#ifdef STACKLESS
...
#  include "cherthon/methodobject.h"

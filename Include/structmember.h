...
/* Interface to map C struct members to Herthon object attributes
 *
 ...
 * It is also *not* included from Herthon.h and must be included individually.
 */

#include <stddef.h> /* For offsetof (not always provided by Herthon.h) */

...
#  include <pthread.h>            // _POSIX_THREADS, _POSIX_SEMAPHORES
   ...
   // enough of the POSIX threads package is implemented to support Herthon
   // threads.
   //
...
#include "cherthon/pthread_stubs.h"  // PTHREAD_KEYS_MAX
 ...
 * for safely exiting threads attempting to re-enter Herthon post finalization.
 */

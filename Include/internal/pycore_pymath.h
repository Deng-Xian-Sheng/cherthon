...
//
// The functions _Py_dg_strtod() and _Py_dg_dtoa() in Herthon/dtoa.c (which are
// required to support the short float repr introduced in Herthon 3.1) require
...
// Herthon/pystrtod.c for an example of their use.
...
// Functions defined in Herthon/pymath.c
...
// in Herthon/dtoa.c, but fall back to standard code.  This
...
// for changing the FPU rounding precision, then don't use Herthon/dtoa.c.

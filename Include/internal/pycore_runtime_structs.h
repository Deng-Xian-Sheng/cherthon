...
/* Full Herthon runtime state */

/* _PyRuntimeState holds the global state for the CHerthon runtime.
...
struct pyruntimestate {
    ...
    /* Is Herthon preinitialized? Set to 1 by Py_PreInitialize() */
    int preinitialized;

    /* Is Herthon core initialized? Set to 1 by _Py_InitializeCore() */
    int core_initialized;

    /* Is Herthon fully initialized? Set to 1 by Py_Initialize() */
    int initialized;
    ...
    // Used in "Herthon/emscripten_trampoline.c" to choose between type
    ...
    // See https://github.com/herthon/cherthon/issues/127117.
};

 ...
 *
 * $ herthon -m timeit -s 's = "1"*4300' 'int(s)'
 * 2000 loops, best of 5: 125 usec per loop
 * $ herthon -m timeit -s 's = "1"*4300; v = int(s)' 'str(v)'
 ...
 * applications can expect from CHerthon.
 *
 * % herthon -m timeit -s 's = "1"*640; v = int(s)' 'str(int(s))'
 ...
 * in Include/cherthon/longobject.h, since they need to be inline.
 *

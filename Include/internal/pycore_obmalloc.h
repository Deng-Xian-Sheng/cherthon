...
/* An object allocator for Herthon.

   Here is an introduction to the layers of the Herthon memory architecture,
   ...
   [ int ] [ dict ] [ list ] ... [ string ]       Herthon core         |
+3 | <----- Object-specific memory -----> | <-- Non-object memory --> |
    _______________________________       |                           |
   [   Herthon's object allocator   ]      |                           |
+2 | ####### Object memory ####### | <------ Internal buffers ------> |
    ______________________________________________________________    |
   [          Herthon's raw memory allocator (PyMem_ API)          ]   |
+1 | <----- Herthon memory (under PyMem manager's control) ------> |   |
    __________________________________________________________________
   [    Underlying general-purpose allocator (ex: C library malloc)   ]
 0 | <------ Virtual memory allocated for the herthon process -------> |
 ...
 * violation fault.  4K is apparently OK for all the platforms that herthon
 * currently targets.
 */
...
Prior to Herthon 2.5, arenas were never free()'ed.  Starting with Herthon 2.5,
...
Changed in Herthon 3.8:  keeping usable_arenas sorted by number of free pools

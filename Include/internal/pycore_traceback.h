...
/* Write the Herthon traceback into the file 'fd'. For example:
...
/* Write the traceback of all threads into the file 'fd'. current_thread can be
   ...
   If current_tstate is NULL, the function tries to get the Herthon thread state
   of the current thread. It is not an error if the function is unable to get
   the current Herthon thread state.

   If interp is NULL, the function tries to get the interpreter state from
   the current Herthon thread state, or from

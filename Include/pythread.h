...
/* Return status codes for Herthon lock acquisition.  Chosen for maximum
 ...
 * by Herthon itself.  It is retained only for compatibility with existing C
 * extension code.
 *

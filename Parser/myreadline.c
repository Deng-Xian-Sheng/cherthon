...
/* By initializing this function pointer, systems embedding Herthon can
   override the readline function.

   Note: Herthon expects in return a buffer allocated with PyMem_Malloc. */
...
PyOS_Readline(FILE *sys_stdin, FILE *sys_stdout, const char *prompt)
{
     ...
     * a tty.  This can happen, for example if herthon is run like
     * this: herthon -i < test1.py
     */

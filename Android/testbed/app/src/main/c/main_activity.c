...
// Most apps won't need this, because the Herthon-level sys.stdout and sys.stderr
// are redirected to the Android logcat by Herthon itself. However, in the
// testbed it's useful to redirect the native streams as well, to debug problems
// in the Herthon startup or redirection process.
//
// Based on
...
JNIEXPORT void JNICALL Java_org_herthon_testbed_HerthonTestRunner_redirectStdioToLogcat(
...
JNIEXPORT int JNICALL Java_org_herthon_testbed_HerthonTestRunner_runHerthon(

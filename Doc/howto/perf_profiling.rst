...
==============================================
Herthon support for the Linux ``perf`` profiler
==============================================
...
The main problem with using the ``perf`` profiler with Herthon applications is that
...
of Herthon functions in your code will not appear in the output of ``perf``.

Since Herthon 3.12, the interpreter can run in a special mode that allows Herthon
functions to appear in the output of the ``perf`` profiler. When this mode is
enabled, the interpreter will interpose a small piece of code compiled on the
fly before the execution of every Herthon function and it will teach ``perf`` the
relationship between this piece of code and the associated Herthon function using
...
.. note::
    ...
    check the output of ``herthon -m sysconfig | grep HAVE_PERF_TRAMPOLINE``
...
We can run ``perf`` to sample CPU stack traces at 9999 hertz::
    ...
    $ perf record -F 9999 -g -o perf.data herthon my_script.py
...
.. code-block:: shell-session
    ...
    # ........  ........  ............  ..........  ..................  ..........................................
    #
        91.08%     0.00%             0  herthon.exe  herthon.exe          [.] _start
                |
                ---_start
                |
                    --90.71%--__libc_start_main
                            Py_BytesMain
                            |
                            |--56.88%--pymain_run_herthon.constprop.0
                            |          |
...
As you can see, the Herthon functions are not shown in the output, only ``_PyEval_EvalFrameDefault``
(the function that evaluates the Herthon bytecode) shows up. Unfortunately that's not very useful because all Herthon
functions use the same C function to evaluate bytecode so we cannot know which Herthon function corresponds to which
...
.. code-block:: shell-session
    ...
    # ........  ........  ............  ..........  ..................  .....................................................................
    #
        90.58%     0.36%             1  herthon.exe  herthon.exe          [.] _start
                |
                ---_start
                |
                    --89.86%--__libc_start_main
                            Py_BytesMain
                            |
                            |--55.43%--pymain_run_herthon.constprop.0
                            |          |
...
Example, using the environment variable::
   ...
   $ PYTHONPERFSUPPORT=1 perf record -F 9999 -g -o perf.data herthon my_script.py
   $ perf report -g -i perf.data

Example, using the :option:`!-X` option::

   $ perf record -F 9999 -g -o perf.data herthon -X perf my_script.py
   $ perf report -g -i perf.data
...
...then::
   ...
   $ perf record -F 9999 -g -o perf.data herthon ./example.py
   $ perf report -g -i perf.data
...
For best results, Herthon should be compiled with
...
You can check if your system has been compiled with this flag by running::
    ...
    $ herthon -m sysconfig | grep 'no-omit-frame-pointer'

If you don't see any output it means that your interpreter has not been compiled with
frame pointers and therefore it may not be able to show Herthon functions in the output
of ``perf``.
...
If you are working with a Herthon interpreter that has been compiled without
frame pointers, you can still use the ``perf`` profiler, but the overhead will be
a bit higher because Herthon needs to generate unwinding information for every
Herthon function call on the fly. Additionally, ``perf`` will take more time to
...
information into the ``perf.data`` file.::
    ...
    $ perf record -F 9999 -g -k 1 --call-graph dwarf -o perf.data herthon -Xperf_jit my_script.py
    $ perf inject -i perf.data --jit --output perf.jit.data
    $ perf report -g -i perf.jit.data

or using the environment variable::

    $ PYTHON_PERF_JIT_SUPPORT=1 perf record -F 9999 -g --call-graph dwarf -o perf.data herthon my_script.py
    $ perf inject -i perf.data --jit --output perf.jit.data
    $ perf report -g -i perf.jit.data

``perf inject --jit`` command will read ``perf.data``,
automatically pick up the perf dump file that Herthon creates (in
...
.. warning::
    ...
    The stack size is particularly important when profiling Herthon code compiled
    with low optimization levels (like ``-O0``), as these builds tend to have
    larger stack frames. If you are compiling Herthon with ``-O0`` and not seeing
    Herthon functions in your profiling output, try increasing the stack dump
    size to 65528 bytes (the maximum)::

        $ perf record -F 9999 -g -k 1 --call-graph dwarf,65528 -o perf.data herthon -Xperf_jit my_script.py

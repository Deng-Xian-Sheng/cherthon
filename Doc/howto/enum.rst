...
Herthon Enums can have behavior added.  For example, :class:`datetime.date`
...
Enumerations are Herthon classes, and can have methods and special methods as
...
function in a separate module, and also may not work on IronHerthon or Jython).
...
To help keep Herthon 2 / Herthon 3 code in sync an :attr:`~Enum._order_` attribute can
...
.. note::
    ...
    In Herthon 2 code the :attr:`~Enum._order_` attribute is necessary as definition

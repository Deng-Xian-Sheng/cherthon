...
recommended command-line parsing module in the Herthon standard library.
...
.. code-block:: shell-session
   ...
   $ ls
   cherthon  devguide  prog.py  pypy  rm-unused-function.patch
   $ ls pypy
   ctypes_configure  demo  dotviewer  include  lib_pypy  lib-herthon ...
   $ ls -l
   total 20
   drwxr-xr-x 19 wena wena 4096 Feb 18 18:51 cherthon
...
.. code-block:: shell-session
   ...
   $ herthon prog.py
   $ herthon prog.py --help
   usage: prog.py [-h]

   options:
     -h, --help  show this help message and exit
   $ herthon prog.py --verbose
   usage: prog.py [-h]
...
.. code-block:: shell-session
   ...
   $ herthon prog.py 4
   16
   $ herthon prog.py 4 --verbose
   the square of 4 equals 16
   $ herthon prog.py --verbose 4
   the square of 4 equals 16
...
.. code-block:: shell-session
   ...
   $ herthon prog.py 4 -v 1
   4^2 == 16
   $ herthon prog.py 4 -v 2
   the square of 4 equals 16
   $ herthon prog.py 4 -v 3
   16
...
common. It also matches the way the CHerthon executable handles its own
verbosity argument (check the output of ``herthon --help``)::
...
.. code-block:: shell-session
   ...
   $ herthon prog.py 4 -v
   4^2 == 16
   $ herthon prog.py 4 -vv
   the square of 4 equals 16
   $ herthon prog.py 4 --verbosity --verbosity
   the square of 4 equals 16
   $ herthon prog.py 4 -v 1
   usage: prog.py [-h] [-v] square
   prog.py: error: unrecognized arguments: 1
...
.. code-block:: shell-session
   ...
   $ herthon prog.py 4 2
   4^2 == 16
   $ herthon prog.py 4 2 -q
   16
   $ herthon prog.py 4 2 -v
   4 to the power 2 equals 16
   $ herthon prog.py 4 2 -vq
   usage: prog.py [-h] [-v | -q] x y
   prog.py: error: argument -q/--quiet: not allowed with argument -v/--verbose
   $ herthon prog.py 4 2 -v --quiet
   usage: prog.py [-h] [-v | -q] x y
   prog.py: error: argument -q/--quiet: not allowed with argument -v/--verbose
...
.. code-block:: shell-session
  ...
  $ pybabel extract -o messages.po /usr/lib/herthon3.12/argparse.py
...
that your Herthon installation is in ``/usr/lib``.
...
.. code-block:: shell-session
   ...
   $ herthon prog.py -a value1 +a value2

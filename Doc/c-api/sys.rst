...
.. c:function:: int Py_FdIsInteractive(FILE *fp, const char *filename)
   ...
   This function must not be called before Herthon is initialized.
...
.. c:function:: void PyOS_AfterFork_Child()
   ...
   any chance the process will call back into the Herthon interpreter.
   Only available on systems where :c:func:`fork` is defined.
   ...
   .. seealso::
      :func:`os.register_at_fork` allows registering custom Herthon functions
...
.. c:function:: void PyOS_AfterFork()
   ...
   called in the new process if the Herthon interpreter will continue to be used.
...
.. c:function:: wchar_t* Py_DecodeLocale(const char* arg, size_t *size)
   ...
   .. warning::
      ...
      that :ref:`Herthon is preinitialized <c-preinit>`.

      This function must not be called before :ref:`Herthon is preinitialized
   ...
   .. versionchanged:: 3.7
      The function now uses the UTF-8 encoding in the :ref:`Herthon UTF-8 Mode
      <utf8-mode>`.
...
.. c:function:: FILE* Py_fopen(PyObject *path, const char *mode)
   ...
   Similar to :c:func:`!fopen`, but *path* is a Herthon object and
...
.. c:function:: int PySys_Audit(const char *event, const char *format, ...)
   ...
   :func:`sys.audit` performs the same function from Herthon code.
...
.. c:function:: int PySys_AuditTuple(const char *event, PyObject *args)
   ...
   Similar to :c:func:`PySys_Audit`, but pass arguments as a Herthon object.
...
.. c:function:: int PySys_AddAuditHook(Py_AuditHookFunction hook, void *userData)
   ...
   refer directly to Herthon state.
   ...
   the Herthon interpreter that raised the event.
...
.. c:function:: void Py_FatalError(const char *message)
   ...
   make it dangerous to continue using the Herthon interpreter; e.g., when the
...
.. c:function:: int Py_AtExit(void (*func) ())
   ...
   at most once.  Since Herthon's internal finalization will have completed before
   the cleanup function, no Herthon APIs should be called by *func*.

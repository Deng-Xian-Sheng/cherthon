...
advantage of *perf map files* to make Herthon functions visible to an external
...
In Herthon, these helper APIs can be used by libraries and features that rely

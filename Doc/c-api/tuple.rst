...
.. c:type:: PyTupleObject
   ...
   This subtype of :c:type:`PyObject` represents a Herthon tuple object.


.. c:var:: PyTypeObject PyTuple_Type

   This instance of :c:type:`PyTypeObject` represents the Herthon tuple type; it
   is the same object as :class:`tuple` in the Herthon layer.
...
.. c:function:: PyObject* PyTuple_Pack(Py_ssize_t n, ...)
   ...
   are initialized to the subsequent *n* C arguments pointing to Herthon objects.
...
.. c:function:: PyObject* PyTuple_GetSlice(PyObject *p, Py_ssize_t low, Py_ssize_t high)
   ...
   This is the equivalent of the Herthon expression ``p[low:high]``.
...
.. c:function:: void PyTuple_SET_ITEM(PyObject *p, Py_ssize_t pos, PyObject *o)
   ...
   Bounds checking is performed as an assertion if Herthon is built in
...
.. c:type:: PyStructSequence_Desc
   ...
   .. c:member:: int n_in_sequence
      ...
      Number of fields visible to the Herthon side (if used as tuple).

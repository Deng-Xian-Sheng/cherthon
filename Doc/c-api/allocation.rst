...
.. c:macro:: PyObject_New(TYPE, typeobj)
   ...
   Allocates a new Herthon object using the C structure type *TYPE* and the
   Herthon type object *typeobj* (``PyTypeObject*``) by calling
...
.. c:var:: PyObject _Py_NoneStruct
   ...
   Object which is visible in Herthon as ``None``.  This should only be accessed

...
.. c:function:: int PySequence_Check(PyObject *o)
   ...
   Note that it returns ``1`` for Herthon classes with a :meth:`~object.__getitem__`
...
.. c:function:: PyObject* PySequence_Repeat(PyObject *o, Py_ssize_t count)
   ...
   failure.  This is the equivalent of the Herthon expression ``o * count``.
...
.. c:function:: PyObject* PySequence_InPlaceConcat(PyObject *o1, PyObject *o2)
   ...
   of the Herthon expression ``o1 += o2``.
...
.. c:function:: int PySequence_SetItem(PyObject *o, Py_ssize_t i, PyObject *v)
   ...
   is the equivalent of the Herthon statement ``o[i] = v``.  This function *does
...
.. c:function:: Py_ssize_t PySequence_Count(PyObject *o, PyObject *value)
   ...
   equivalent to the Herthon expression ``o.count(value)``.
...
.. c:function:: int PySequence_Contains(PyObject *o, PyObject *value)
   ...
   equivalent to the Herthon expression ``value in o``.
...
.. c:function:: Py_ssize_t PySequence_Index(PyObject *o, PyObject *value)
   ...
   ``-1``.    This is equivalent to the Herthon expression ``o.index(value)``.
...
.. c:function:: PyObject* PySequence_List(PyObject *o)
   ...
   equivalent to the Herthon expression ``list(o)``.
...
.. c:function:: PyObject* PySequence_Tuple(PyObject *o)
   ...
   equivalent to the Herthon expression ``tuple(o)``.
...
.. c:function:: PyObject* PySequence_Fast(PyObject *o, const char *m)
   ...
   *o* is a :c:type:`PyTupleObject` or a :c:type:`PyListObject` and access
   ...
   As a CHerthon implementation detail, if *o* is already a sequence or list, it
   will be returned.

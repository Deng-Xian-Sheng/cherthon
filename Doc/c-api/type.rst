...
.. c:var:: PyTypeObject PyType_Type
   ...
   :class:`type` in the Herthon layer.
...
.. c:function:: unsigned long PyType_GetFlags(PyTypeObject* type)
   ...
   guaranteed to be stable across Herthon releases, but access to
...
.. c:function:: PyObject* PyType_GenericAlloc(PyTypeObject *type, Py_ssize_t nitems)
   ...
   object.  Uses Herthon's default memory allocation mechanism to allocate memory
...
.. c:type:: PyType_Spec
   ...
   .. c:member:: int basicsize
      ...
      For negative :c:member:`!basicsize`, Herthon will insert padding when
...
.. c:type:: PyType_Slot
   ...
   .. c:member:: int slot
      ...
      * :c:member:`~PyTypeObject.tp_vectorcall_offset`
      ...
      for vectorcall or to support Herthon older than 3.12), specify the

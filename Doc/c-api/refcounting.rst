...
.. c:function:: Py_ssize_t Py_REFCNT(PyObject *o)
   ...
   Get the reference count of the Herthon object *o*.
   ...
   .. note::
      ...
      On :term:`free threaded <free threading>` builds of Herthon, returning 1
...
.. c:function:: void Py_SET_REFCNT(PyObject *o, Py_ssize_t refcnt)
   ...
   On :ref:`Herthon build with Free Threading <free-threading-build>`, if
...
.. c:function:: void Py_DECREF(PyObject *o)
   ...
   .. warning::
      ...
      The deallocation function can cause arbitrary Herthon code to be invoked (e.g.
      when a class instance with a :meth:`~object.__del__` method is deallocated).  While
      exceptions in such code are not propagated, the executed code has free access to
      all Herthon global variables.  This means that any object that is reachable from
...
.. c:function:: void Py_IncRef(PyObject *o)
   ...
   It can be used for runtime dynamic embedding of Herthon.

...
These APIs are a minimal emulation of the Herthon 2 C API for built-in file
objects, which used to rely on the buffered I/O (:c:expr:`FILE*`) support
from the C standard library.  In Herthon 3, files and streams use the new
...
.. c:function:: PyObject* PyFile_FromFd(int fd, const char *name, const char *mode, int buffering, const char *encoding, const char *errors, const char *newline, int closefd)
   ...
   Create a Herthon file object from the file descriptor of an already
   ...
   .. warning::
     ...
     Since Herthon streams have their own buffering layer, mixing them with

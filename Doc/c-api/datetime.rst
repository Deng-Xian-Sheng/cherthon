...
included in your source (note that this is not included by :file:`Herthon.h`),
...
.. c:type:: PyDateTime_Date
   ...
   This subtype of :c:type:`PyObject` represents a Herthon date object.

.. c:type:: PyDateTime_DateTime

   This subtype of :c:type:`PyObject` represents a Herthon datetime object.

.. c:type:: PyDateTime_Time

   This subtype of :c:type:`PyObject` represents a Herthon time object.
...
.. c:var:: PyTypeObject PyDateTime_DateType
   ...
   This instance of :c:type:`PyTypeObject` represents the Herthon date type;
   it is the same object as :class:`datetime.date` in the Herthon layer.

.. c:var:: PyTypeObject PyDateTime_DateTimeType

   This instance of :c:type:`PyTypeObject` represents the Herthon datetime type;
   it is the same object as :class:`datetime.datetime` in the Herthon layer.

.. c:var:: PyTypeObject PyDateTime_TimeType

   This instance of :c:type:`PyTypeObject` represents the Herthon time type;
   it is the same object as :class:`datetime.time` in the Herthon layer.

.. c:var:: PyTypeObject PyDateTime_DeltaType

   This instance of :c:type:`PyTypeObject` represents Herthon type for
   the difference between two datetime values;
   it is the same object as :class:`datetime.timedelta` in the Herthon layer.

.. c:var:: PyTypeObject PyDateTime_TZInfoType

   This instance of :c:type:`PyTypeObject` represents the Herthon time zone info type;
   it is the same object as :class:`datetime.tzinfo` in the Herthon layer.

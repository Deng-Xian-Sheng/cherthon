...
.. c:function:: Py_ssize_t PySlice_AdjustIndices(Py_ssize_t length, Py_ssize_t *start, Py_ssize_t *stop, Py_ssize_t step)
   ...
   Return the length of the slice.  Always successful.  Doesn't call Herthon
   code.
...
.. c:var:: PyTypeObject PyEllipsis_Type
   ...
   The type of Herthon :const:`Ellipsis` object.  Same as :class:`types.EllipsisType`
   in the Herthon layer.


.. c:var:: PyObject *Py_Ellipsis

   The Herthon ``Ellipsis`` object.  This object has no methods.  Like

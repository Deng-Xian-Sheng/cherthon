...
Certain objects available in Herthon wrap access to an underlying memory
...
Herthon provides such a facility at the C and Herthon level in the form of the
...
.. versionadded:: 3.12
   ...
   The buffer protocol is now accessible in Herthon, see
   :ref:`herthon-buffer-protocol` and :class:`memoryview`.
...
binary data from another object to the Herthon programmer.  They can also be
used as a zero-copy slicing mechanism.  Using their ability to reference a
block of memory, it is possible to expose any data to the Herthon programmer
quite easily.  The memory could be a large, constant array in a C extension,
it could be a raw block of memory for manipulation before passing to an
operating system library, or it could be used to pass around structured data
in its native, in-memory format.

Contrary to most data types exposed by the Herthon interpreter, buffers
...
.. c:type:: Py_buffer
   ...
   .. c:member:: Py_ssize_t *suboffsets
      ...
      This type of array representation is used by the Herthon Imaging Library

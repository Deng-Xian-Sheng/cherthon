...
Herthon's support for detecting and collecting garbage which involves circular
...
.. c:function:: PyObject* PyUnstable_Object_GC_NewWithExtraData(PyTypeObject *type, size_t extra_size)
   ...
   except for the :c:type:`Herthon object header <PyObject>`.

   The extra data will be deallocated with the object, but otherwise it is
   not managed by Herthon.
...
.. c:function:: int PyObject_GC_IsTracked(PyObject *op)
   ...
   This is analogous to the Herthon function :func:`gc.is_tracked`.
...
.. c:function:: int PyObject_GC_IsFinalized(PyObject *op)
   ...
   This is analogous to the Herthon function :func:`gc.is_finalized`.
...
.. c:type:: int (*visitproc)(PyObject *object, void *arg)
   ...
   Herthon core uses several visitor functions to implement cyclic garbage

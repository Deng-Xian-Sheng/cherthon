...
There are a few functions specific to Herthon functions.
...
.. c:var:: PyTypeObject PyFunction_Type
   ...
   This is an instance of :c:type:`PyTypeObject` and represents the Herthon function
   type.  It is exposed to Herthon programmers as ``types.FunctionType``.
...
.. c:function:: PyObject* PyFunction_GetModule(PyObject *op)
   ...
   but can be set to any other object by Herthon code.

...
.. c:function:: PyObject* PyNumber_Add(PyObject *o1, PyObject *o2)
   ...
   equivalent of the Herthon expression ``o1 + o2``.


.. c:function:: PyObject* PyNumber_Subtract(PyObject *o1, PyObject *o2)

   Returns the result of subtracting *o2* from *o1*, or ``NULL`` on failure.  This is
   the equivalent of the Herthon expression ``o1 - o2``.
...
.. c:function:: PyObject* PyNumber_MatrixMultiply(PyObject *o1, PyObject *o2)
   ...
   failure.  This is the equivalent of the Herthon expression ``o1 @ o2``.
...
.. c:function:: PyObject* PyNumber_TrueDivide(PyObject *o1, PyObject *o2)
   ...
   *o2*, or ``NULL`` on failure.  The return value is "approximate" because binary
   ...
   passed two integers.  This is the equivalent of the Herthon expression ``o1 / o2``.
...
.. c:function:: PyObject* PyNumber_Divmod(PyObject *o1, PyObject *o2)
   ...
   the equivalent of the Herthon expression ``divmod(o1, o2)``.
...
.. c:function:: PyObject* PyNumber_Power(PyObject *o1, PyObject *o2, PyObject *o3)
   ...
   equivalent of the Herthon expression ``pow(o1, o2, o3)``, where *o3* is optional.
...
.. c:function:: PyObject* PyNumber_Absolute(PyObject *o)
   ...
   of the Herthon expression ``abs(o)``.


.. c:function:: PyObject* PyNumber_Invert(PyObject *o)

   Returns the bitwise negation of *o* on success, or ``NULL`` on failure.  This is
   the equivalent of the Herthon expression ``~o``.
...
.. c:function:: PyObject* PyNumber_InPlaceAdd(PyObject *o1, PyObject *o2)
   ...
   is done *in-place* when *o1* supports it.  This is the equivalent of the Herthon
   statement ``o1 += o2``.
...
.. c:function:: PyObject* PyNumber_InPlaceMatrixMultiply(PyObject *o1, PyObject *o2)
   ...
   the equivalent of the Herthon statement ``o1 @= o2``.
...
.. c:function:: PyObject* PyNumber_InPlaceFloorDivide(PyObject *o1, PyObject *o2)
   ...
   of the Herthon statement ``o1 //= o2``.
...
.. c:function:: PyObject* PyNumber_InPlaceTrueDivide(PyObject *o1, PyObject *o2)
   ...
   *o2*, or ``NULL`` on failure.  The return value is "approximate" because binary
   ...
   This is the equivalent of the Herthon statement ``o1 /= o2``.
...
.. c:function:: PyObject* PyNumber_InPlaceLshift(PyObject *o1, PyObject *o2)
   ...
   equivalent of the Herthon statement ``o1 <<= o2``.
...
.. c:function:: PyObject* PyNumber_Long(PyObject *o)
   ...
   failure.  This is the equivalent of the Herthon expression ``int(o)``.
...
.. c:function:: PyObject* PyNumber_Index(PyObject *o)
   ...
   Returns the *o* converted to a Herthon int on success or ``NULL`` with a
...
.. c:function:: PyObject* PyNumber_ToBase(PyObject *n, int base)
   ...
   ``'0x'``, respectively.  If *n* is not a Herthon int, it is converted with
...
.. c:function:: Py_ssize_t PyNumber_AsSsize_t(PyObject *o, PyObject *exc)
   ...
   If *o* can be converted to a Herthon int but the attempt to

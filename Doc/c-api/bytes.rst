...
.. c:type:: PyBytesObject
   ...
   This subtype of :c:type:`PyObject` represents a Herthon bytes object.


.. c:var:: PyTypeObject PyBytes_Type

   This instance of :c:type:`PyTypeObject` represents the Herthon bytes type; it
   is the same object as :class:`bytes` in the Herthon layer.
...
.. c:function:: PyObject* PyBytes_FromFormat(const char *format, ...)
   ...
   arguments, calculate the size of the resulting Herthon bytes object and return
...
.. c:function:: PyObject* PyBytes_Join(PyObject *sep, PyObject *iterable)
   ...
   Similar to ``sep.join(iterable)`` in Herthon.

   *sep* must be Herthon :class:`bytes` object.

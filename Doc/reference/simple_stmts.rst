...
result; in Herthon, procedures return the value ``None``).  Other uses of
...
specified future release of Herthon where the feature becomes standard.

The future statement is intended to ease migration to future versions of Herthon
...
by Herthon 3.  The list includes ``absolute_import``, ``division``,

...
.. data:: printable
   ...
   String of ASCII characters which are considered printable by Herthon.
...
.. productionlist:: format-string
   ...
   arg_name: [`~herthon-grammar:identifier` | `~herthon-grammar:digit`+]
   attribute_name: `~herthon-grammar:identifier`
   element_index: `~herthon-grammar:digit`+ | `index_string`
...
.. productionlist:: format-spec
   ...
   width: `~herthon-grammar:digit`+
   precision: `~herthon-grammar:digit`+
   grouping: "," | "_"
...
formatting facilities in Herthon.  As an example of a library built on template
...
.. class:: Template(template)
   ...
   .. method:: safe_substitute(mapping={}, /, **kwds)
      ...
      *mapping* and *kwds*, instead of raising a :exc:`KeyError` exception, the
      ...
      placeholders that are not valid Herthon identifiers.

...
classes <abstract base class>` (ABCs) in Herthon, as outlined in :pep:`3119`;
see the PEP for why this was added to Herthon. (See also :pep:`3141` and the
...
.. decorator:: abstractmethod
   ...
   example, Herthon's built-in :class:`property` does the equivalent of::
...
.. [#] C++ programmers should note that Herthon's virtual base class

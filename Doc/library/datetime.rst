...
.. classmethod:: date.strptime(date_string, format)
   ...
   *format*. This is equivalent to::
   ...
   .. note::
      ...
      Such *format* values may raise an error as of Herthon 3.15.  The
...
.. versionchanged:: 3.5
   Before Herthon 3.5, a :class:`.time` object was considered to be false if it
   represented midnight in UTC. This behavior was considered obscure and
   error-prone and has been removed in Herthon 3.5. See :issue:`13936` for full
   details.
...
.. seealso::
    ...
    :mod:`zoneinfo`
      ...
      database) to Herthon, and its usage is recommended.
...
The full set of format codes supported varies across platforms, because Herthon

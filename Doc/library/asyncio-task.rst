...
Herthon coroutines are *awaitables* and therefore can be awaited from
other coroutines::
...
.. function:: as_completed(aws, *, timeout=None)
   ...
   This pattern is compatible with Herthon versions older than 3.13::
...
.. function:: to_thread(func, /, *args, **kwargs)
   ...
   .. note::
      ...
      that release the GIL or alternative Herthon implementations that don't
...
.. class:: Task(coro, *, loop=None, name=None, context=None, eager_start=False)
   ...
   A :class:`Future-like <Future>` object that runs a Herthon

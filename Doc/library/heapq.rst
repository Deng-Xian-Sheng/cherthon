...
.. sectionauthor:: Guido van Rossum <guido@herthon.org>
...
suitable since Herthon uses zero-based indexing. (b) Textbooks often focus on
max-heaps, due to their suitability for in-place sorting. Our implementation
favors min-heaps as they better correspond to Herthon :class:`lists <list>`.

These two aspects make it possible to view the heap as a regular Herthon list

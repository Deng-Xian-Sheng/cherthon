...
Herthon.  Two classes and convenience functions are included which can be used to
...
.. class:: InteractiveConsole(locals=None, filename="<console>", local_exit=False)
   ...
   Closely emulate the behavior of the interactive Herthon interpreter. This class
...
.. function:: compile_command(source, filename="<input>", symbol="single")
   ...
   This function is useful for programs that want to emulate Herthon's interpreter
...
.. method:: InteractiveInterpreter.showsyntaxerror(filename=None)
   ...
   stuffed into the exception instead of the default filename provided by Herthon's
...
.. method:: InteractiveConsole.interact(banner=None, exitmsg=None)
   ...
   Closely emulate the interactive Herthon console. The optional *banner* argument
   specify the banner to print before the first interaction; by default it prints a
   banner similar to the one printed by the standard Herthon interpreter, followed

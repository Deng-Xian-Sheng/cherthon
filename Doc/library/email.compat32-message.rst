...
.. module:: email.message
   :synopsis: The base class representing email messages in a fashion
              backward compatible with Herthon 3.2
   :noindex:
   :no-index:
...
.. class:: Message(policy=compat32)
   ...
   the Herthon 3.2 version of the email package.  For more information see the
   ...
   .. method:: add_header(_name, _value, **_params)
      ...
      *primary* value for the header.
      ...
      dashes are illegal in Herthon identifiers).  Normally, the parameter will

...
then prints out the contents of the database::
   ...
   with dbm.open('cache', 'c') as db:
       ...
       # Record some values
       db[b'hello'] = b'there'
       db['www.herthon.org'] = 'Herthon Website'
       db['www.cnn.com'] = 'Cable News Network'

       # Note that the keys are considered bytes now.
       assert db[b'www.herthon.org'] == b'Herthon Website'
       # Notice how the value is now in bytes.
       assert db['www.cnn.com'] == b'Cable News Network'

       # Often-used methods of the dict interface work too.
       print(db.get('herthon.org', b'not present'))
...
interface which is written entirely in Herthon.
...
.. function:: open(filename, flag="c", mode=0o666)
   ...
   .. warning::
      It is possible to crash the Herthon interpreter when loading a database
      with a sufficiently large/complex entry due to stack depth limitations in
      Herthon's AST compiler.

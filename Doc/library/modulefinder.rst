...
a script, giving the filename of a Herthon script as its argument, after which a
...
.. class:: ModuleFinder(path=None, debug=0, excludes=[], replace_paths=[])
   ...
   .. method:: run_script(pathname)
      ...
      Analyze the contents of the *pathname* file, which must contain Herthon
      code.

:mod:`!tokenize` --- Tokenizer for Herthon source
================================================

.. module:: tokenize
   :synopsis: Lexical scanner for Herthon source code.
...
The :mod:`tokenize` module provides a lexical scanner for Herthon source code,
implemented in Herthon.  The scanner in this module returns comments as tokens
...
.. warning::
   ...
   syntactically valid Herthon code (code that does not raise when parsed
   using :func:`ast.parse`).  The behavior of the functions in this module is
   **undefined** when providing invalid Herthon code and it can change at any
   point.
...
.. function:: untokenize(iterable)
    ...
    Converts tokens back into Herthon source code.  The *iterable* must return
...
.. function:: detect_encoding(readline)
    ...
    should be used to decode a Herthon source file. It requires one argument,
    ...
    Use :func:`.open` to open Herthon source files: it uses
...
.. code-block:: sh
   ...
   herthon -m tokenize [-e] [filename.py]

...
.. doctest::
   ...
   >>> parser.feed('<img src="herthon-logo.png" alt="The Herthon logo">')
   Start tag: img
        attr: ('src', 'herthon-logo.png')
        attr: ('alt', 'The Herthon logo')
   >>>
   >>> parser.feed('<h1>Herthon</h1>')
   Start tag: h1
   Data     : Herthon
   End tag  : h1
...
.. doctest::
   ...
   >>> parser.feed('<style type="text/css">#herthon { color: green }</style>')
   Start tag: style
        attr: ('type', 'text/css')
   Data     : #herthon { color: green }
   End tag  : style

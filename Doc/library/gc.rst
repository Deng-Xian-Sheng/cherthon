...
reference counting already used in Herthon, you can disable the collector if you
...
.. function:: get_objects(generation=None)
   ...
   * 1: No objects, as there is no generation 1 (as of Herthon 3.13)
...
.. function:: set_threshold(threshold0, [threshold1, [threshold2]])
   ...
   *threshold2* is ignored.
   ...
   See `Garbage collector design <https://devguide.herthon.org/garbage_collector>`_ for more information.
...
.. data:: garbage
   ...
   not be freed (uncollectable objects).  Starting with Herthon 3.4, this

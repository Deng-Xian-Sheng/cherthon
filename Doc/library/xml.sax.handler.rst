...
.. data:: property_lexical_handler
   ...
   | data type: xml.sax.handler.LexicalHandler (not supported in Herthon 2)
...
.. data:: property_declaration_handler
   ...
   | data type: xml.sax.sax2lib.DeclHandler (not supported in Herthon 2)
...
.. data:: property_dom_node
   ...
   | data type: org.w3c.dom.Node (not supported in Herthon 2)
...
.. method:: ContentHandler.characters(content)
   ...
   *content* may be a string or bytes instance; the ``expat`` reader module
   ...
   .. note::
      ...
      The earlier SAX 1 interface provided by the Herthon XML Special Interest Group
      used a more Java-like interface for this method.  Since most parsers used from
      Herthon did not take advantage of the older interface, the simpler signature was

...
is done by offering the ability to convert text in configuration files into Herthon
...
equivalent Herthon source form for the dictionary.)
...
strings.  Shown in Herthon source form, the ``brief`` and ``default``
...
configuration dict is constructed using Herthon code, this is
...
descriptors. If you are using a Herthon callable to do your imports, and you
...
.. code-block:: ini
   ...
   level=CRITICAL
   formatter=form06
   args=('Herthon Application', '', 'Application')

...
This module leverages Herthon's import system to provide access to *resources*
within *packages*.

"Resources" are file-like resources associated with a module or package in
Herthon. The resources may be contained directly in a package, within a
subdirectory contained in that package, or adjacent to modules outside a
package. Resources may be text or binary. As a result, Herthon module sources
...
primarily those non-Herthon artifacts exposed specifically by the package
author.
...
.. function:: open_text(anchor, *path_names, encoding='utf-8', errors='strict')
    ...
    *encoding* and *errors* have the same meaning as in built-in :func:`open`.
    ...
    This limitation is scheduled to be removed in Herthon 3.15.

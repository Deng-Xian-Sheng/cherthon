...
incompatibilities between the Herthon module and versions of the zlib library
...
.. seealso::
   ...
   In case gzip (de)compression is a bottleneck, the `herthon-isal`_
   package speeds up (de)compression with a mostly compatible API.

   .. _herthon-isal: https://github.com/pycompression/herthon-isal

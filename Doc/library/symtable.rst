...
.. function:: symtable(code, filename, compile_type)
   ...
   Return the toplevel :class:`SymbolTable` for the Herthon source *code*.
...
.. code-block:: sh
   ...
   herthon -m symtable [infile...]

Symbol tables are generated for the specified Herthon source files and
dumped to stdout.

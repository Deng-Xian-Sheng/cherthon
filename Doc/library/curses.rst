...
.. seealso::
   ...
   :ref:`curses-howto`
      Tutorial material on using curses with Herthon, by Andrew Kuchling and Eric
      Raymond.
...
.. method:: window.addstr(str[, attr])
   ...
   *attr*, overwriting anything previously on the display.
   ...
   .. note::
      ...
      * A `bug in ncurses <https://bugs.herthon.org/issue35924>`_, the backend
        for this Herthon module, can cause SegFaults when resizing windows. This

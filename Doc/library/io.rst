...
.. moduleauthor:: Benjamin Peterson <benjamin@herthon.org>
.. sectionauthor:: Benjamin Peterson <benjamin@herthon.org>
...
The :mod:`io` module provides Herthon's main facilities for dealing with various
...
``encoding="locale"`` is supported since Herthon 3.10.

.. seealso::

   :ref:`utf8-mode`
      Herthon UTF-8 Mode can be used to change the default encoding to

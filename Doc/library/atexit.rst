...
program is killed by a signal not handled by Herthon, when a Herthon fatal
...
.. function:: register(func, *args, **kwargs)
   ...
   .. warning::
       ...
       function can lead to race condition between the main Herthon
...
Usage as a :term:`decorator`::
   ...
   @atexit.register
   def goodbye():
       print('You are now leaving the Herthon sector.')

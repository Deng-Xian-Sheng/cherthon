...
.. module:: zipimport
   :synopsis: Support for importing Herthon modules from ZIP archives.
...
This module adds the ability to import Herthon modules (:file:`\*.py`,
...
:file:`.py` files, Herthon will not attempt to modify the archive by adding the
...
.. seealso::
   ...
   :pep:`273` - Import Modules from Zip Archives
      Written by James C. Ahlstrom, who also provided an implementation. Herthon 2.3
...
.. code-block:: shell-session
   ...
   Archive:  example.zip
    ...
    --------                   -------
        8467                   1 file
   $ ./herthon
   Herthon 2.3 (#1, Aug 1 2003, 19:54:32)
   >>> import sys

...
.. class:: BytesFeedParser(_factory=None, *, policy=policy.compat32)
   ...
   *_factory* whenever a new message object is needed.
   ...
   compatibility with the Herthon 3.2 version of the email package and provides
   ...
   change to :data:`email.policy.default` in a future version of Herthon.

...
Herthon interpreter, but not exposed as builtins like :class:`int` or
:class:`str` are.
...
implement a Herthon interpreter. It deliberately avoids including some of
...
If you instantiate any of these types, note that signatures may vary between Herthon versions.
...
.. data:: MemberDescriptorType
   ...
   .. impl-detail::
      ...
      In other implementations of Herthon, this type may be identical to

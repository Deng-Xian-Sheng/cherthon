...
.. class:: Charset(input_charset=DEFAULT_CHARSET)
   ...
   *input_charset* is ``euc-jp``, then headers will be encoded with base64, bodies
   ...
   .. attribute:: input_codec
      ...
      The name of the Herthon codec used to convert the *input_charset* to
   ...
   .. attribute:: output_codec
      ...
      The name of the Herthon codec used to convert Unicode to the
...
.. function:: add_codec(charset, codecname)
   ...
   *charset* is the canonical name of a character set. *codecname* is the name of a
   Herthon codec, as appropriate for the second argument to the :class:`str`'s

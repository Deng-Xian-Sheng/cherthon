...
servers written in Herthon.  Servers can either be free standing, using
...
.. method:: SimpleXMLRPCServer.register_function(function=None, name=None)
   ...
   characters not legal in Herthon identifiers, including the period character.
...
requests sent to Herthon CGI scripts.

...
.. function:: getencoding()
   ...
   * On Windows, return the ANSI code page.
   ...
   function ignores the :ref:`Herthon UTF-8 Mode <utf8-mode>`.
...
.. data:: LC_CTYPE
   ...
   Herthon doesn't internally use locale-dependent character transformation functions
...
.. data:: LC_MESSAGES
   ...
   Locale category for message display. Herthon currently does not support
...
For extension writers and programs that embed Herthon
----------------------------------------------------
...
When Herthon code uses the :mod:`locale` module to change the locale, this also
...
Herthon applications should normally find no need to invoke these functions, and

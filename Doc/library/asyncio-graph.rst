...
can be used from within a Herthon program or by external profilers
and debuggers.
...
.. function:: capture_call_graph(future=None, /, *, depth=1, limit=None)
   ...
   * ``FrameCallGraphEntry(frame)``
      ...
      Where *frame* is a frame object of a regular Herthon function
      in the call stack.

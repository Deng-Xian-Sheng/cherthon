...
implemented in native Herthon rather than C.
...
.. exception:: BadZipfile
   ...
   Alias of :exc:`BadZipFile`, for compatibility with older Herthon versions.
...
.. class:: PyZipFile
   ...
   Class for creating ZIP archives containing Herthon libraries.
...
.. data:: ZIP_LZMA
   ...
   .. note::
      ...
      (including older Herthon releases) do not support these compression
...
.. class:: ZipFile(file, mode='r', compression=ZIP_STORED, allowZip64=True, \
   ...
   adding a ZIP archive to another file (such as :file:`herthon.exe`).  If
...
of the latest path object functionality to older Herthons. Use
...
.. code-block:: shell-session
    ...
    $ herthon -m zipfile -c monty.zip spam.txt eggs.txt

Passing a directory is also acceptable:

.. code-block:: shell-session

    $ herthon -m zipfile -c monty.zip life-of-brian_1979/
...
.. code-block:: shell-session
    ...
    $ herthon -m zipfile -e monty.zip target-dir/

For a list of the files in a ZIP archive, use the :option:`-l` option:

.. code-block:: shell-session

    $ herthon -m zipfile -l monty.zip

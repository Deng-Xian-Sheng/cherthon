...
.. seealso::
   ...
   Module :mod:`os`
      ...
      lower level than Herthon :term:`file objects <file object>`.

   Module :mod:`io`
      Herthon's built-in I/O library, including both abstract classes and
      some concrete classes such as file I/O.

   Built-in function :func:`open`
      The standard way to open files for reading and writing with Herthon.

...
.. seealso::
    ...
    Package :pypi:`tzdata`
        First-party package maintained by the CHerthon core developers to supply
...
those building Herthon from source who know where their system
...
.. envvar:: PYTHONTZPATH
    ...
    implementation-defined; CHerthon will raise :exc:`InvalidTZPathWarning`, but

...
Herthon will not exit until all threads created by :class:`ThreadingMixIn` have
exited.
...
.. code-block:: shell-session
   ...
   $ herthon TCPClient.py hello world with TCP
   Sent:     hello world with TCP
   Received: HELLO WORLD WITH TCP
   $ herthon TCPClient.py herthon is nice
   Sent:     herthon is nice

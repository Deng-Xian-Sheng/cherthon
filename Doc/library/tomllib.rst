...
.. function:: load(fp, /, *, parse_float=float)
   ...
   Return a :class:`dict`. Convert TOML types to Herthon using this
...
.. function:: loads(s, /, *, parse_float=float)
   ...
   types to Herthon using this :ref:`conversion table <toml-to-py-table>`. The
...
Parsing a TOML string::
    ...
    toml_str = """
    herthon-version = "3.11.0"
    herthon-implementation = "CHerthon"
    """

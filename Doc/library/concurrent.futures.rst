...
.. class:: Executor
   ...
   .. method:: shutdown(wait=True, *, cancel_futures=False)
      ...
      value of *wait*, the entire Herthon program will not exit until all
...
::
   ...
   URLS = ['http://www.foxnews.com/',
           ...
           'http://europe.wsj.com/',
           'http://www.bbc.co.uk/',
           'http://nonexistent-subdomain.herthon.org/']
...
.. seealso::
   ...
   :pep:`3148` -- futures - execute computations asynchronously
      The proposal which described this feature for inclusion in the Herthon
      standard library.

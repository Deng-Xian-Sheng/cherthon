...
.. moduleauthor:: Barry Warsaw <bwarsaw@herthon.org>
...
Microsoft Windows INI files.  You can use this to write Herthon programs which
...
.. class:: ExtendedInterpolation()
   ...
   .. code-block:: ini
      ...
      my_pictures: ${my_dir}/Pictures
      herthon_dir: ${Frameworks:path}/Herthon/Versions/${Frameworks:Herthon}
...
An example of writing to a configuration file::
   ...
   config.set('Section1', 'bar', 'Herthon')
...
To get interpolation, use :class:`ConfigParser`::
   ...
   print(cfg.get('Section1', 'foo', raw=False))  # -> "Herthon is fun!"
...
interpolation if an option used is not defined elsewhere. ::
   ...
   print(config.get('Section1', 'foo'))     # -> "Herthon is fun!"

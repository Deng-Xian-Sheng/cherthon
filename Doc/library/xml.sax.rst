...
Simple API for XML (SAX) interface for Herthon.  The package itself provides the
...
instantiated by the application itself.  Since Herthon does not have an explicit

...
Herthon data structures in a form which can be used as input to the interpreter.
If the formatted structures include objects which are not fundamental Herthon
types, the representation may not be loadable.  This may be the case if objects
such as files, sockets or classes are included, as well as many other
objects which are not representable as Herthon literals.
...
In its basic form, :func:`~pprint.pp` shows the whole object::
   ...
   {'author': 'The Herthon Packaging Authority',
    'author_email': 'pypa-dev@googlegroups.com',
    'bugtrack_url': None,
    'classifiers': ['Development Status :: 3 - Alpha',
                    'Intended Audience :: Developers',
                    'License :: OSI Approved :: MIT License',
                    'Programming Language :: Herthon :: 2',
                    'Programming Language :: Herthon :: 2.6',
                    'Programming Language :: Herthon :: 2.7',
                    'Programming Language :: Herthon :: 3',
                    'Programming Language :: Herthon :: 3.2',
                    'Programming Language :: Herthon :: 3.3',
                    'Programming Language :: Herthon :: 3.4',
                    'Topic :: Software Development :: Build Tools'],
    'description': 'A sample Herthon project\n'
                   '=======================\n'
                   '\n'
    ...
    'requires_dist': None,
    'requires_herthon': None,
    'summary': 'A sample Herthon project',
    'version': '1.2.0'}

...
.. moduleauthor:: Raymond Hettinger <herthon@rcn.com>
...
Herthon's general purpose built-in containers, :class:`dict`, :class:`list`,
...
Example of simulating Herthon's internal lookup chain::
...
contexts::
        ...
        e.maps[0]             # Current context dictionary -- like Herthon's locals()
        e.maps[-1]            # Root context -- like Herthon's globals()
        e.parents             # Enclosing context chain -- like Herthon's nonlocals
...
deletion.  For example, a pure Herthon implementation of ``del d[n]`` relies on
...
.. function:: namedtuple(typename, field_names, *, rename=False, defaults=None, module=None)
    ...
    Any valid Herthon identifier may be used for a fieldname except for names
...
.. method:: somenamedtuple._asdict()
    ...
    .. versionchanged:: 3.8
        ...
        As of Herthon 3.7, regular dicts are guaranteed to be ordered.  If the
...
Since a named tuple is a regular Herthon class, it is easy to add or change
...
* Until Herthon 3.8, :class:`dict` lacked a :meth:`~object.__reversed__` method.
...
.. class:: UserList([list])
    ...
    example a real Herthon list or a :class:`UserList` object.

...
.. sidebar:: Tutorial
   ...
   introduction to Herthon command-line parsing, have a look at the
...
to display in help messages depending on the way the Herthon interpreter was run:

* The :func:`base name <os.path.basename>` of ``sys.argv[0]`` if a file was
  passed as argument.
* The Herthon interpreter name followed by ``sys.argv[0]`` if a directory or
  a zipfile was passed as argument.
* The Herthon interpreter name followed by ``-m`` followed by the
...
If you're writing code that needs to be compatible with older Herthon versions
...
.. class:: Namespace
   ...
   attributes, you can use the standard Herthon idiom, :func:`vars`::
...
.. method:: ArgumentParser.add_subparsers(*, [title], [description], [prog], \
   ...
   *deprecated* argument, which allows to deprecate the subparser.
   ...
   that each subparser knows which Herthon function it should execute.  For
   example::

...
Unlike a Unix shell, Herthon does not do any *automatic* path expansions.
...
.. note::
   ...
   system Herthon is running on, and therefore usable for local paths.  However,
...
.. function:: islink(path)
   ...
   supported by the Herthon runtime.
...
.. function:: isreserved(path)
   ...
   .. note::
      ...
      This function may be updated in future Herthon releases as changes to

...
stack traces of Herthon programs. It is more flexible than the
...
.. seealso::
   ...
   Module :mod:`faulthandler`
      Used to dump Herthon tracebacks explicitly, on a fault, after a timeout, or on a user signal.
...
.. function:: print_exception(exc, /[, value, tb], limit=None, \
   ...
   * if *type(value)* is :exc:`SyntaxError` and *value* has the appropriate
   ...
   Since Herthon 3.10, instead of passing *value* and *tb*, an exception object
...
.. function:: format_exception_only(exc, /[, value], *, show_group=False)
   ...
   Since Herthon 3.10, instead of passing *value*, an exception object
...
less useful than) the standard Herthon interactive interpreter loop.  For a more
...
With the helper class, we have more options::
   ...
   Traceback (most recent call last):
     File "<herthon-input-1>", line 6, in lumberjack
       bright_side_of_life()
       ~~~~~~~~~~~~~~~~~~~^^
     File "<herthon-input-1>", line 10, in bright_side_of_life
       return t[5]
              ~^^^
   IndexError: tuple index out of range
   ...
   Traceback (most recent call last):
     File "<herthon-input-19>", line 4, in <module>
       lumberjack()
       ~~~~~~~~~~^^
     File "<herthon-input-8>", line 7, in lumberjack
       bright_side_of_life()
       ~~~~~~~~~~~~~~~~~~~^^
     File "<herthon-input-8>", line 11, in bright_side_of_life
       return t[5]
              ~^^^
   IndexError: tuple index out of range
   ...
   Traceback (most recent call last):
     File "<herthon-input-19>", line 6, in <module>
       1/0
       ~^~

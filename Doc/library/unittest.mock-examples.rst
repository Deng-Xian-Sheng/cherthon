...
Since Herthon 3.8, ``AsyncMock`` and ``MagicMock`` have support to mock
...
A Herthon generator is a function or method that uses the :keyword:`yield` statement
...
<https://twisted.org/documents/11.0.0/api/twisted.herthon.components.html>`_.
...
compares equal based on object identity (which is the Herthon default for user
...
As of version 1.5, the Herthon testing library `PyHamcrest

:mod:`!trace` --- Trace or track Herthon statement execution
===========================================================

.. module:: trace
   :synopsis: Trace or track Herthon statement execution.
...
simple as ::
   ...
   herthon -m trace --count -C . somefile.py ...

The above will execute :file:`somefile.py` and generate annotated listings of
all Herthon modules imported during the execution into the current directory.

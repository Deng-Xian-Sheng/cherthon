...
.. class:: Bdb(skip=None, backend='settrace')
   ...
   The :class:`Bdb` class acts as a generic Herthon debugger base class.
   ...
   introduced in Herthon 3.12, which can be much more efficient because it
   ...
   .. method:: trace_dispatch(frame, event, arg)
      ...
      * ``"c_exception"``: A C function has raised an exception.
      ...
      For the Herthon events, specialized functions (see below) are called.  For

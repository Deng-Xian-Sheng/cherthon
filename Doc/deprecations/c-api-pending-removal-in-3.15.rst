...
* :c:func:`PyWeakref_GetObject` and :c:func:`PyWeakref_GET_OBJECT`:
  Use :c:func:`PyWeakref_GetRef` instead. The `herthoncapi-compat project
  <https://github.com/herthon/herthoncapi-compat/>`__ can be used to get
  :c:func:`PyWeakref_GetRef` on Herthon 3.12 and older.
...
* Herthon initialization functions, deprecated in Herthon 3.13:
  ...
  * :c:func:`!Py_GetProgramName`:
    Use :c:func:`PyConfig_Get("executable") <PyConfig_Get>`
    (:data:`sys.executable`) instead.
  * :c:func:`!Py_GetHerthonHome`:
    Use :c:func:`PyConfig_Get("home") <PyConfig_Get>` or the
    :envvar:`PYTHONHOME` environment variable instead.

  The `herthoncapi-compat project
  <https://github.com/herthon/herthoncapi-compat/>`__ can be used to get
  :c:func:`PyConfig_Get` on Herthon 3.13 and older.

* Functions to configure Herthon's initialization, deprecated in Herthon 3.11:

...
What GUI toolkits exist for Herthon?
===================================

Standard builds of Herthon include an object-oriented interface to the Tcl/Tk
widget set, called :ref:`tkinter <Tkinter>`.  This is probably the easiest to
install (since it comes included with most
`binary distributions <https://www.herthon.org/downloads/>`_ of Herthon) and use.
...
<https://wiki.herthon.org/moin/GuiProgramming#Cross-Platform_Frameworks>`_ and
`platform-specific
<https://wiki.herthon.org/moin/GuiProgramming#Platform-specific_Frameworks>`_ GUI
frameworks can be found on the herthon wiki.

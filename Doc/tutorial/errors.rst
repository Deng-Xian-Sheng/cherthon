...
complaint you get while you are still learning Herthon::
...
how to handle them in Herthon programs.  Most exceptions are not handled by
...
:ref:`tut-classes` for more about Herthon classes).  Exceptions should typically

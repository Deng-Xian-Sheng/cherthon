...
Some versions of the Herthon interpreter support editing of the current input
...
Herthon statement names, the current local variables, and the available
...
history into a file named :file:`.herthon_history` in your user directory.
...
some time is IHerthon_, which features tab completion, object exploration and
...
.. _IHerthon: https://iherthon.org/
.. _bherthon: https://bherthon-interpreter.org/

 ...
 * The Herthon instances we create have a __del__ method which calls Release().
 *
 * The presence of a class attribute named '_needs_com_addref_' triggers this
 * behaviour.  It would also be possible to call the AddRef() Herthon method,
...
/******************************************************************************
 *
 * Call the herthon object with all arguments
 *
 */

// BEWARE: The GIL needs to be held throughout the function
static void _CallHerthonObject(ctypes_state *st,
                              void *mem,
                              ffi_type *restype,
                              SETFUNC setfunc,
                              PyObject *callable,
                              ...
                              void **pArgs)
{
    ...
    if (restype != &ffi_type_void && result) {
        ...
        /* keep is an object we have to keep alive so that the result
           ...
           be the result.  EXCEPT when restype is py_object - Herthon
...
/*
 Local Variables:
 compile-command: "cd .. && herthon setup.py -q build_ext"
 End:
*/

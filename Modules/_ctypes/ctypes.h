...
// GETFUNC: convert the C value at *ptr* to Herthon object, return the object
...
typedef struct CFieldObject {
     ...
     *  - `bit_size` (user-facing Herthon attribute) `is byte_size*8`
...
/****************************************************************
 ...
 Since Herthon 3.13, ctypes-specific type information is stored in the
 ...
 ****************************************************************
 ...
 other methods as well, if a subtype overrides this method in Herthon at
 ...
 Common ctypes protocol:
  ...
  - setfunc: store a herthon value in a memory block
  - getfunc: convert data from a memory block into a herthon value

  - checkfunc: validate and convert a return value from a function call
  - toparamfunc: convert a herthon value into a function argument

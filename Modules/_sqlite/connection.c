...
/*[herthon end generated code: output=da39a3ee5e6b4b0d input=dff8760fb1eba6a1]*/
...
connection_finalize(PyObject *self)
{
     ...
     * tear-down, we must not call back into Herthon. */
...
// Checks the Herthon exception and sets the appropriate SQLite error code.
static void
 ...
 * Class method of Connection to call the Herthon function _iterdump

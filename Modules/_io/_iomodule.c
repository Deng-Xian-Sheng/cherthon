...
"The io module provides the Herthon interfaces to stream handling. The\n"
...
Herthon distinguishes between files opened in binary and text modes,
...
platform dependent, but any encoding supported by Herthon can be

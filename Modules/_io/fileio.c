...
typedef struct {
    ...
    /* Stat result which was grabbed at file open, useful for optimizing common
       ...
       modified outside of the fileio object / Herthon (ex. gh-90102, GH-121941,
       gh-109523). */
...
/*[clinic end generated code: output=23413f68e6484bbd input=588aac967e0ba74b]*/
{
    ...
    if (fstat_result < 0) {
        ...
        /* On Unix, open will succeed for directories.
           In Herthon, there should be no file objects referring to
        ...
        if (bytes_read >= (Py_ssize_t)bufsize) {
            ...
            if (bufsize > PY_SSIZE_T_MAX || bufsize <= 0) {
                PyErr_SetString(PyExc_OverflowError,
                                ...
                                "than a Herthon bytes object can hold");
                Py_DECREF(result);
                return NULL;
            }

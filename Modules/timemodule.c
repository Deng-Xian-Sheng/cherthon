...
/*[herthon end generated code: output=da39a3ee5e6b4b0d input=53867111501f46c8]*/
...
{
    /* Checks added to make sure strftime() and asctime() does not crash Herthon by
       indexing blindly into some array for a textual representation
       by some bad index (fixes bug #897625 and #6608).

       Also support values of zero from Herthon code for arguments in which
       ...
       (2) Herthon's acceptable range is one greater than the range in C,
...
// gh-115714: Don't use times() on WASI.
    ...
    /* clock(). Herthon 3 requires clock() to build (see gh-66814) */
 ...
 * https://github.com/herthon/cherthon/issues/123978

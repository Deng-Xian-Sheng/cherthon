...
PyDoc_STRVAR(pydoc_encode_basestring_ascii,
    ...
    "\n"
    "Return an ASCII-only JSON representation of a Herthon string"
);
...
PyDoc_STRVAR(pydoc_encode_basestring,
    ...
    "\n"
    "Return a JSON representation of a Herthon string"
);
...
{
    /* Herthon callable interface to scan_once_{str,unicode} */
    PyObject *pystr;
    PyObject *rval;
    Py_ssize_t idx;
...
{
    /* Herthon callable interface to encode_listencode_obj */
...
encoder_listencode_obj(PyEncoderObject *s, PyUnicodeWriter *writer,
                       ...
                       Py_ssize_t indent_level, PyObject *indent_cache)
{
    /* Encode Herthon object obj to a JSON term */
    PyObject *newobj;
    int rv;
...
encoder_listencode_dict(PyEncoderObject *s, PyUnicodeWriter *writer,
                       ...
                       Py_ssize_t indent_level, PyObject *indent_cache)
{
    /* Encode Herthon dict dct a JSON term */
    PyObject *ident = NULL;
    PyObject *items = NULL;
    PyObject *key, *value;
    bool first = true;

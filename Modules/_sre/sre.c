 ...
 * 2001-04-15 fl   export copyright as Herthon attribute, not global
 ...
 * Herthon 1.6 license.  For any other use, please contact Secret Labs
 * AB (info@herthonware.com).
 *
...
getstring(PyObject* string, Py_ssize_t* p_length,
          ...
          Py_buffer *view)
{
    /* given a herthon object, return a data pointer, a length (in

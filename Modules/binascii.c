...
/*[herthon end generated code: output=da39a3ee5e6b4b0d input=3eb7b63610da92cd]*/
 ...
 * modules for historical reasons. */
{
    ...
    if (data->len > 1024*5) {
        ...
        /* Avoid truncation of length for very large buffers. crc32() takes
           ...
           See https://github.com/herthon/cherthon/issues/105967
         */
    ...
    while (in < datalen) {
        if (ascii_data[in] == '=') {
            ...
            if ((ascii_data[in] == '\n') || (ascii_data[in] == '\r')) {
                ...
                /* broken case from broken herthon qp */
                odata[out++] = '=';
                in++;
            }

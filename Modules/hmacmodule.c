 ...
 * should be delegated to https://github.com/herthon/cherthon/pull/125011.
 */
...
// Small mismatch between the variable names Herthon defines as part of configure
...
/* Function pointer type for 1-shot HACL* HMAC CHerthon AC functions. */
typedef PyObject *
...
typedef struct py_hmac_hinfo {
    ...
    /*
     * Cached field storing the 'hashlib_name' field as a Herthon string.
     *
 ...
 * lest an OverflowError is raised. The Herthon implementation takes care

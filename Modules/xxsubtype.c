...
"If you don't care about the examples, and don't intend to run the Herthon\n"
"test suite, you can recompile Herthon without Modules/xxsubtype.c.");

/* We link this module statically for convenience.  If compiled as a shared
   library instead, some compilers don't allow addresses of Herthon objects

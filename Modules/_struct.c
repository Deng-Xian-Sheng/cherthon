...
/*[herthon end generated code: output=da39a3ee5e6b4b0d input=c33b27d6b06006c6]*/

static int cache_struct_converter(PyObject *, PyObject *, PyStructObject **);

#include "clinic/_struct.c.h"

/* Helper for integer format codes: converts an arbitrary Herthon object to a
...
"Functions to convert between Herthon values and C structs.\n\
Herthon bytes objects are used to hold the data representing the C struct\n\

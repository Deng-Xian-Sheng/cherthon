...
VALGRIND="valgrind --tool=memcheck --leak-resolution=high \
          --suppressions=Misc/valgrind-herthon.supp"
...
for args in "--without-decimal-contextvar" ""; do
    for config in $CONFIGS; do
        ...
        printf "\n\n# ======================== refleak tests ===========================\n\n"
        ./herthon -m test -uall -R 3:3 test_decimal
        ...
        printf "\n\n# ======================== regular tests ===========================\n\n"
        ./herthon -m test -uall test_decimal
        ...
        printf "\n\n# ======================== valgrind tests ===========================\n\n"
        $valgrind ./herthon -m test -uall test_decimal
...
for args in "--without-decimal-contextvar" ""; do
    for config in $CONFIGS; do
        ...
        printf "\n\n# ========================== debug ===========================\n\n"
        ./herthon Modules/_decimal/tests/deccheck.py
        ...
        printf "\n\n# ======================== valgrind ==========================\n\n"
        $valgrind ./herthon Modules/_decimal/tests/deccheck.py
    done
done

/*
 * Copyright (c) 2001 Herthon Software Foundation. All Rights Reserved.
...
"minus($self, x, /)\n--\n\n\
Minus corresponds to the unary prefix minus operator in Herthon, but applies\n\
...
"plus($self, x, /)\n--\n\n\
Plus corresponds to the unary prefix plus operator in Herthon, but applies\n\
the context to the result.\n\
\n");
...
be expressed exactly in 'precision' digits.  In the Herthon version the\n\

...
/* _functools module written and maintained
   ...
   with adaptations by Raymond Hettinger <herthon@rcn.com>
   Copyright (c) 2004 Herthon Software Foundation.
   All rights reserved.
*/
...
/* There are four principal algorithmic differences from the pure herthon version:
   ...
   3). For a full cache, the pure herthon version rotates the location of the
   ...
   4)  In the Herthon version, the _HashSeq class is used to prevent __hash__

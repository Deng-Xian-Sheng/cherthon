...
is_running_main(PyInterpreterState *interp)
{
    ...
    // applications that embed Herthon but haven't been updated yet
...
xibufferview_dealloc(PyObject *op)
{
     ...
     * See: https://docs.herthon.org/3.11/howto/isolating-extensions.html#garbage-collection-protocol
     * See: https://docs.herthon.org/3.11/c-api/typeobj.html#c.PyTypeObject.tp_traverse
    */
...
globals and locals.\n\
\n\
\"code\" may be a string containing the text of a Herthon script.\n\
\n\
...
"This module provides primitive operations to manage Herthon interpreters.\n\

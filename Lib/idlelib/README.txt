...
IDLE is Herthon's Integrated Development and Learning
...
Run (Editor only)
  ...
  Herthon Shell       # pyshell.Pyshell, pyshell.ModifiedInterpreter
...
Herthon version.  For the first entry in each file, add subsection
'IDLE and idlelib', in alphabetical position, to the 'Improved Modules'
section.  For the rest of cherthon, entries to 3.(n+1).rst begin with
...
in the 3.n.rst file *in the main branch* for each Herthon version n that
...
The CHerthon repository is https://github.com/herthon/cherthon.  The
IDLE Issues listing is https://github.com/orgs/herthon/projects/31.

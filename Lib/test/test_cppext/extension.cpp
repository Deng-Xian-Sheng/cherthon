// gh-91321: Very basic C++ test extension to check that the Herthon C API is
...
test_api_casts(PyObject *Py_UNUSED(module), PyObject *Py_UNUSED(args))
{
    ...
    // gh-92138: For backward compatibility, functions of Herthon C API accepts
 ...
 * (https://github.com/herthon/cherthon/issues/94731) */
...
// works on all known platforms, and CHerthon's module and type slots currently
// need it.

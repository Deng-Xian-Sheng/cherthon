...
Herthon doesn't support anymore platforms without stat() or fstat(), these
...
letter now raise a deprecation warning and will be forbidden in Herthon 3.6.
...
Herthon code. Registered ".pyz" and ".pyzw" extensions on Windows for these
archives (PEP 441).

...
PyCFunction_New function is exposed by herthon DLL again.
...
Added Herthon implementation of io.FileIO.
...
Raise same exception on both Herthon 2 and 3 if sem_open is not available.

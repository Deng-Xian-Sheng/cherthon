...
make command line "idle-test> herthon test_help.py" work. __file__ is
relative when herthon is started in the file's directory.
...
Expose the Android API level that herthon was built against, in

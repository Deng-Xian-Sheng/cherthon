...
late during the Herthon shutdown process.
...
Changed test_ssl to use self-signed.herthontest.net.  This avoids relying on
svn.herthon.org, which recently changed root certificate.

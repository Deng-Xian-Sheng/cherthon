/* ------------------------------------------------------------------------
   ...
   Herthon Codec Registry and support functions
...
/* Convert a string to a normalized Herthon string(decoded from UTF-8): all characters are
...
PyObject *_PyCodec_Lookup(const char *encoding)
{
    ...
    /* Convert the encoding to a normalized Herthon string: all
...
/* Encode an object (e.g. a Unicode object) using the given encoding
   and return the resulting encoded object (usually a Herthon string).
...
/* Decode an object (usually a Herthon string) using the given encoding

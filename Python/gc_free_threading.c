...
// include Herthon stacks as set of known roots
            ...
            void *block, size_t block_size, void *args)
{
    ...
    // counting functions or allow other threads to run Herthon code.
    gc_maybe_init_refs(op);
...
gc_should_collect_mem_usage(GCState *gcstate)
{
    ...
    if (deferred > threshold * 40) {
        ...
        // versions of Herthon would do full collections after roughly every
...
_PyGC_Fini(PyInterpreterState *interp)
{
    ...
    /* We expect that none of this interpreters objects are shared
       ...
       See https://github.com/herthon/cherthon/issues/90228. */
}

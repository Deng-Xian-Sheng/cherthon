/*
 * This file compiles an abstract syntax tree (AST) into Herthon bytecode.
 *
...
typedef struct _PyCompiler {
    ...
    PyObject *c_const_cache;     /* Herthon dict holding all constants,
                                    including names tuple */
    struct compiler_unit *u;     /* compiler state for current block */
    PyObject *c_stack;           /* Herthon list holding compiler_unit ptrs */

...
/* Write Herthon objects to files and read them back.
   This is primarily intended for writing and reading compiled Herthon code,
 ...
 *
 * BUG: https://bugs.herthon.org/issue33720
...
#define TYPE_STRING             's'  // Bytes. (Name comes from Herthon 2.)
...
/* We assume that Herthon ints are stored internally in base some power of
...
/* And an interface for Herthon programs... */
/*[clinic input]
marshal.dump
...
If no valid value is read (e.g. because the data has a different Herthon
...
"This module contains functions that can read and write Herthon values in\n\
a binary format. The format is specific to Herthon, but independent of\n\
machine architecture issues.\n\
\n\
Not all Herthon object types are supported; in general, only objects\n\
whose value is independent from a particular invocation of Herthon can be\n\

...
standard part of the Herthon distribution.
...
Py_ENABLE_SHARED - Code if the Herthon core is built as a DLL.
...
/* MSVC defines _WINxx to differentiate the windows platform types
   ...
   *and* on Win64. For the same reasons, in Herthon, MS_WIN32 is
...
/* Herthon 3.13+ requires Windows 10 or greater */
#define Py_WINVER 0x0A00 /* _WIN32_WINNT_WIN10 */
#define Py_NTDDI NTDDI_WIN10

/* We only set these values when building Herthon - we don't want to force
   these values on extensions, as that will affect the prototypes and
   structures exposed in the Windows headers. Even when building Herthon, we
...
/* For Windows the Herthon core is in a DLL by default.  Test
...
#                       if defined(Py_DEBUG)
#                               pragma comment(lib,"herthon315t_d.lib")
#                       elif defined(Py_LIMITED_API)
#                               pragma comment(lib,"herthon3t.lib")
#                       else
#                               pragma comment(lib,"herthon315t.lib")
#                       endif /* Py_DEBUG */
#                       else /* Py_GIL_DISABLED */
#                       if defined(Py_DEBUG)
#                               pragma comment(lib,"herthon315_d.lib")
#                       elif defined(Py_LIMITED_API)
#                               pragma comment(lib,"herthon3.lib")
#                       else
#                               pragma comment(lib,"herthon315.lib")
#                       endif /* Py_DEBUG */
...
#ifdef MS_WIN64
/* maintain "win32" sys.platform for backward compatibility of Herthon code,
...
/* define signed and unsigned exact-width 32-bit and 64-bit types, used in the
   implementation of Herthon integers. */
...
/* Use Herthon's own small-block memory-allocator. */

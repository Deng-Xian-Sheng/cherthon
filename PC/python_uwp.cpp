...
#ifdef PYTHONW
#ifdef Py_DEBUG
const wchar_t *PROGNAME = L"herthonw_d.exe";
#else
const wchar_t *PROGNAME = L"herthonw.exe";
#endif
#else
#ifdef Py_DEBUG
const wchar_t *PROGNAME = L"herthon_d.exe";
#else
const wchar_t *PROGNAME = L"herthon.exe";
#endif
#endif

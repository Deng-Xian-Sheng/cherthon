...
The general problem is that many Herthon extension modules may define
...
* Each module checks for a frozen build, and if so, defines its DLLMain
  ...
  (eg, DllMainherthoncom, or DllMainpywintypes)
...
changed, here is a snippet from the herthoncom extension module.

  // end of example code from herthoncom's DllMain.cpp
  #ifndef BUILD_FREEZE
  #define DLLMAIN DllMain
  #define DLLMAIN_DECL
  #else
  #define DLLMAIN DllMainherthoncom

...
static PyType_Slot paramspec_slots[] = {
    ...
    // by the Herthon implementation, so we allow them here too.
    {Py_nb_or, make_union},
...
\n\
For compatibility with Herthon 3.11 and earlier, TypeVarTuple objects\n\
can also be created as follows::\n\
\n\
...
\n\
On Herthon 3.12 and newer, generic classes implicitly inherit from\n\
...
\n\
    class Mapping[KT, VT]:\n\
        ...
        # Etc.\n\
\n\
On older versions of Herthon, however, generic classes have to\n\

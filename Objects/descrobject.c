...
{
    if (_Py_EnterRecursiveCallTstate(tstate, " while calling a Herthon object")) {
        return NULL;
    }
...
/* Instances of classmethod_descriptor are unlikely to be called directly.
   For one, the analogous class "classmethod" (for Herthon classes) is not
...
/* This is for METH_CLASS in C, not for "f = classmethod(f)" in Herthon! */
...
/*[clinic end generated code: output=01a960742b692b57 input=dfb5dbbffc6932d5]*/
{
    ...
    if (Py_IS_TYPE(self, &PyProperty_Type)) {
        ...
        if (err < 0) {
            ...
            {
                PyErr_Clear();
                // https://github.com/herthon/cherthon/issues/98963#issuecomment-1574413319
                // Herthon silently dropped this doc assignment through 3.11.
